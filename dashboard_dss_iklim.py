...
st.set_page_config(page_title="DSS Iklim Kepri", layout="wide")

st.title("🌦️ Decision Support System Iklim - Kepulauan Riau")
...
if uploaded_file:
    ...
    data = process_data("KEPRI - SM TAREMPA.xlsx")
